...
ident = pygit2.Signature('comcellsui', 'comcells@ui')
try:
...
stable_update_script = os.path.join(repo_path, ".ci/update_windows/update_comcellsui_stable.bat")
stable_update_script_to = os.path.join(cur_path, "update_comcellsui_stable.bat")
