...
class SaveAudio:
    ...
    def INPUT_TYPES(s):
        return {"required": { "audio": ("AUDIO", ),
                              "filename_prefix": ("STRING", {"default": "audio/Comcells"})},
    ...
    def save_audio(self, audio, filename_prefix="Comcells", prompt=None, extra_pnginfo=None):
